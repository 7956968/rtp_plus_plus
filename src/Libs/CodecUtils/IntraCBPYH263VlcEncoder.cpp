...
FILE NAME					: IntraCBPYH263VlcEncoder.cpp
...
#include "IntraCBPYH263VlcEncoder.h"
...
---------------------------------------------------------------------------
*/
IntraCBPYH263VlcEncoder::IntraCBPYH263VlcEncoder(void)
{
	_numCodeBits	= 0;
	_bitCode			= 0;
}//end constructor.
...
*/
int	IntraCBPYH263VlcEncoder::Encode(int symbol)
{
	int cbpy	= symbol;
