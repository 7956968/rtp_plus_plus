...
MODULE						: VectorQuantiserDim16Impl

TAG								: VQD16I1

FILE NAME					: VectorQuantiserDim16Impl.h
...
DESCRIPTION				: A class to implement the IVectorQuantiser interface for video 
										...
										fast implementation with early exit short cuts. NOTE: After 
...
===========================================================================
*/
#ifndef _VECTORQUANTISERDIM16IMPL1_H
#define _VECTORQUANTISERDIM16IMPL1_H
...
===========================================================================
*/
class VectorQuantiserDim16Impl1 : public IVectorQuantiser
{
public:
	VectorQuantiserDim16Impl1();
	virtual ~VectorQuantiserDim16Impl1();
...
};// end class VectorQuantiserDim16Impl1.

#endif	// _VECTORQUANTISERDIM16IMPL1_H
