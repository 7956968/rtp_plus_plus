 ...
 */
class SctpSvcRtpPacketisationSessionManager : public RtpSessionManager
{
public:
  static std::unique_ptr<SctpSvcRtpPacketisationSessionManager> create(boost::asio::io_service& ioService,
                                                                const GenericParameters& applicationParameters);

  SctpSvcRtpPacketisationSessionManager(boost::asio::io_service& ioService,
                                 const GenericParameters& applicationParameters);

  ~SctpSvcRtpPacketisationSessionManager();
