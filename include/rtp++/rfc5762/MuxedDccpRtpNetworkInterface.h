...
*/
class MuxedDccpRtpNetworkInterface : public RtpNetworkInterface
{
public:

  MuxedDccpRtpNetworkInterface( boost::asio::io_service& rIoService, const EndPoint& localRtpEp, const EndPoint& remoteRtpEp, bool bIsActiveConnection );
  virtual ~MuxedDccpRtpNetworkInterface();
...
protected:
  ...
  void handleMuxedRtpRtcpPacket(const boost::system::error_code& ec, DccpRtpConnection::ptr pSource, NetworkPacket networkPacket, const EndPoint& ep);
  void handleSentRtpRtcpPacket(const boost::system::error_code& ec, DccpRtpConnection::ptr pSource, Buffer buffer, const EndPoint& ep);
...
protected:
  ...
  /// TCP connections
  boost::asio::ip::dccp::acceptor m_acceptor;
  DccpRtpConnection::ptr m_pConnection;
